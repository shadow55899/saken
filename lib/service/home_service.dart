...
//   Future<Flat> getapartment() async {
//     //you should replace the route ghazallllll
...
//         var data = Flat.fromJson(dataJson); 
// return data;
...
Future<List<Flat>> fetchFlats(String token) async {
            print(" kkkkkkkkkkkkkkkkkkkkk $token");
